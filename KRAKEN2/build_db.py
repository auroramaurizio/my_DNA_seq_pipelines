...
###thank u Sej Modha for this lovely script - credits to you- : https://bioinformatics.cvr.ac.uk/update-kraken-databases/
...
#download_refseq_genome(10116,'rat_genome_url.txt') #10114  #10116 rattus norvegicus
#print('Converting sequences to kraken input format'+'\n')
#get_fasta_in_kraken_format('rat_genome.fa')

#print('Downloading mouse genome'+'\n')
#download_refseq_genome(10090,'mouse_genome_url.txt')
#print('Converting sequences to kraken input format'+'\n')
#get_fasta_in_kraken_format('mouse_genome.fa')

#print('Downloading rabbit genome'+'\n')
#download_refseq_genome(9986,'rabbit_genome_url.txt')
#print('Converting sequences to kraken input format'+'\n')
#get_fasta_in_kraken_format('rabbit_genome.fa')

#print('Downloading bos taurus genome'+'\n')
#download_refseq_genome(9913,'bostaurus_genome_url.txt')
#print('Converting sequences to kraken input format'+'\n')
#get_fasta_in_kraken_format('bostaurus_genome.fa')
...
#https://github.com/DerrickWood/kraken/issues/132

#Set name for the krakendb directory
krakendb='HumanMouseRatRabbitBosVirusBacteria'
subprocess.call('kraken2-build --download-taxonomy --threads 16 --db '+krakendb+'', shell=True)
...
subprocess.call('kraken2-build --build --db '+krakendb+' --threads 16',shell=True)
